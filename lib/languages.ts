...
import  { type LanguageSupport as LS, type StreamParser } from "@codemirror/language";
const importLegacy = () => import("@codemirror/language").then(({LanguageSupport, StreamLanguage}) => {
...
export const SUPPORTED_LANGUAGES: LanguageDefinition[] = [
    {
        id: "typescript",
        label: "TypeScript",
        extension: () => import("@codemirror/lang-javascript").then(({ javascript }) => javascript({jsx: true, typescript: true}))
    },
    {
        id: "javascript",
        label: "JavaScript",
